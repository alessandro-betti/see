...
python ../vprocessor.py --run ../data/skater.avi --out ../exp/skater1\
       --gray 1 --save_scores_only 1 --res 240x180 --day_only 0 --check_params 0 --rep 100000000\
       --all_black 0 --grad 0 --port 8888 --gew 1.0  --frames 1\
       --m 3 --f 3\
       --init_fixed 0 --init_q 1.0\
       --alpha 1.0 --beta 0.00000000625 --gamma 0.0000125 --k 0.000000000000000001 --theta 0.0001\
       --eta 0.1 --rho 0\
       ...
       --lambdaM 0.0 --lambdaE 1000.0 --lambdaC 2000.0
